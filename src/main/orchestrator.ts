...
const TRUTHFUL_FAST_PROMPT =
  ...
  "ГЛАВНОЕ: ОБЯЗАТЕЛЬНО отвечай на вопрос пользователя. Никогда не отказывайся, не говори «не могу», не задавай уточняющих вопросов. " +
  "Вопросы о фактах (президент, даты, события) — отвечай по источникам. Отказ недопустим. " +
